...
export function BookingNotifications({ userId }: { userId: string }) {
  ...
  const handleAcceptCounterOffer = async (
    ...
    try {
      ...
      // 4. Update booking request to client_accepted
      ...
      await supabase.from("notifications").insert({
        ...
        message: `Client accepted your counter-offer of ₦${counterAmount.toLocaleString()} for ${
          request.jobs.title
        }. Awaiting payment.`,
        data: {
      ...
      // 8. Redirect to payment using booking ID
        ...
        <div className="space-y-3">
          {notifications.map((notification) => {
            ...
            const isCounterOffer =
              notification.type === "booking_counter_offer";
